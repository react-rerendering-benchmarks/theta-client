...
export const StringEdit: React.FC<Props> = ({
  ...
  return <InputString title={propName} placeHolder={placeHolder} value={options != null ? getOptionPropString(options, propName) : undefined} onChange={useCallback(value => {
